        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li>
                        <a href="<?= base_url('dosen/penelitian/');?>"><i class="fa fa-fw fa-dashboard"></i> Dashboard</a>
                    </li>
                    <li class="active">
                        <a href="dosen/penelitian/pengisianform"><i class="fa fa-fw fa-edit"></i> Forms</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addFormPengajuan"> <i class="fa fa-plus"></i> Tambah Proposal Penelitian</button>
                    ...
                    <div class="modal-dialog" role="document">
                        ...
                        <div class="modal-body">
                            <form role="form" method="post" action="<?= base_url('dosen/penelitian/addformproposal');?>">
