    ...
    <header class="masthead" style="background-image:url('<?php echo base_url('assets/img/header-bg.jpg'); ?>');">
        <div class="container">
            <div class="intro-text">
                <div class="intro-lead-in"><span>Welcome To Si TeDi</span></div>
                <div class="intro-heading text-uppercase"><span></span></div><a class="btn btn-secondary btn-xl text-uppercase js-scroll-trigger" role="button" href="<?= base_url('dosen/penelitian');?>" style="background-color: rgb(118,54,254);margin-right: 10px;">Penelitian</a><a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger"
                    role="button" href="<?= base_url('dosen/pengabdian/');?>" style="margin-left: 10px;">Pengabdian</a></div>
        </div>
    </header>
