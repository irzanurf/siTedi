<script src="<?= base_url('assets/admin/assets/js/jquery.3.2.1.min.js');?>" type="text/javascript"></script>
    ...
    <script src="<?= base_url('assets/admin/assets/js/bootstrap-notify.js');?>"></script>

    <!--  Google Maps Plugin    -->
    <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=YOUR_KEY_HERE"></script>

    <!-- Light Bootstrap Table Core javascript and methods for Demo purpose -->
	<script src="<?= base_url('assets/admin/assets/js/light-bootstrap-dashboard.js?v=1.4.0');?>"></script>
