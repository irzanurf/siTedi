...
<div class="col-lg-6" style="float:none;margin:auto;">
                    ...
                    <form method="POST" action="<?= base_url('admin/penelitian/updateSkemaPenelitian') ?>">
                    <?php 
                    foreach($skema as $s=>$sk){?>
                    <div class='form-group'>
                                    <label for="bobot">Jenis</label>
                                    <input class='form-control' type="text" id="jenis" name="jenis" value=<?=$sk->jenis?>>
                                </div>
                    <?php }?>
                    ...
                    <!-- <th><?=$id_skema?></th> -->
                            <div class="input-group control-group ">
                                <div class="form-group">
                                    ...
                                    <textarea class='form-control'  id='komponen' name='komponen[]' ><?=$val->komponen?></textarea>
                                </div>
                                <div class='form-group'>
