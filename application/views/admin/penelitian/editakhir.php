                    ...
                    <div class="form">
						<div class="forms">
                            ...
                            <div class="form-group"> 
											...
											<iframe src="<?= base_url('assets/lap_akhir_penelitian');?>/<?=$akhir->file1?>" width="100%" height="400px" >
                                            </iframe>
							                <?php } ?>
                            ...
                            <div class="form-group"> 
											...
											<iframe src="<?= base_url('assets/lap_akhir_penelitian');?>/<?=$akhir->file2?>" width="100%" height="400px" >
                            </iframe>
							<?php } ?>
											<input type="file" accept="application/pdf" name="file2"> 
											<label style="color:red; font-size:12px;">.pdf maks 10mb</label>
							</div> 
                            ...
                            <div class="form-group"> 
											...
											<iframe src="<?= base_url('assets/lap_akhir_penelitian');?>/<?=$akhir->file3?>" width="100%" height="400px" >
                            </iframe>
							<?php } ?>
											<input type="file" accept="application/pdf" name="file3"> 
											<label style="color:red; font-size:12px;">.pdf maks 10mb</label>
                            </div> 
                            ...
                            <h4>Luaran</h4>
											...
											<iframe src="<?= base_url('assets/lap_akhir_penelitian');?>/<?=$luaran[$i]->file?>" width="100%" height="400px" >
                           					 </iframe>
												<?php } ?>
											</div>
