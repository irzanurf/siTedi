    ...
    <div class="row">
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-body">
                ...
                <form role="form" method="post" action="<?= base_url('admin/dashboard/addluaran');?>">  
        ...
        <?php 
                    ...
                    <div class="modal-dialog" role="document">
                        ...
                        <div class="modal-body">
                        <form role="form" method="post" action="<?= base_url('admin/dashboard/editluaran');?>">  
                <div class="form-group">
                        <label>Nama Luaran</label>
                        <input type="hidden" class="form-control" name="id" value=<?=$id?>  >
                        <input type="text" class="form-control" name="luaran" value="<?= $v->luaran ?>" >
                    </div>
