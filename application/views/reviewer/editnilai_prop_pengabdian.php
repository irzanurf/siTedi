...
<div class="row">
                    ...
                    <table class="table">
                    <form method='POST' action="<?= base_url('reviewer/pengabdian/updateNilai');?>" >
                    <input name="id" value="<?=$prop->id?>" hidden>
                        ...
                        <td><input class="form-control" name="<?=$k->id?>" id="skor<?=$no?>" value="<?=$k->skor?>"></td>
                        ...
                        <td><input type="text" name="total_nilai" id="totalnilai" value="<?=$nilai?>" readonly></td>
                        </tr>
